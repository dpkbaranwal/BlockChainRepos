let Auction = artifacts.require("../contracts/Auction.sol");
  ...
  it("Should set winners", function() {
    ...
    ***********/
    return auctionInstance.register({from:accounts[2]}).then(function(result) {
      ...
      ***********/
        return auctionInstance.winners(itemId=0, {from:accounts[0]}).then(function(result) {
      /**********
      ...
      ***********/
      return auctionInstance.winners( itemId=1, {from:accounts[0]}).then(function(result) {
      /**********
      ...
      ***********/
      return  auctionInstance.winners(itemId=2, {from:accounts[3]}).then(function(result) {
      /**********
